              ...
              editingId === t.id ? (
                <div key={t.id} style={{ ...s.card, ...s.editCard }}>
                  <div style={s.formRow}>
                    ...
                    <input
                      ...
                      style={s.input}
                    />
                    <button onClick={() => handleUpdate(t.id)} style={s.primaryButton}>
                      Simpan
                    </button>
                    <button onClick={cancelEdit} style={s.secondaryButton}>
                      Batal
                    </button>
                  </div>
                </div>
                ...
                <div key={t.id} style={s.row}>
                  <span
                    style={{
                      ...s.badge,
                      backgroundColor: t.type === 'income' ? '#14532d' : '#5b1a1a',
                  ...
                  <div style={s.rowActions}>
                    <button onClick={() => startEdit(t)} style={s.iconButton}>
                      Edit
                    </button>
                    <button onClick={() => handleDelete(t.id)} style={s.iconButtonDanger}>
                      Hapus
                    </button>
                  </div>
                </div>
...
const s: Record<string, React.CSSProperties> = {
  ...
  summaryLabel: { fontSize: 12, color: '#a1a1aa' },
  ...
  editCard: { border: '1px solid #3b82f6' },
  cardTitle: { fontSize: 14, fontWeight: 600, marginBottom: 12, color: '#a1a1aa' },
  ...
  rowDate: { fontSize: 13, color: '#a1a1aa', flexShrink: 0, minWidth: 70 },
  rowDesc: { fontSize: 14, flex: 1 },
  ...
  emptyText: { color: '#71717a', textAlign: 'center', padding: '32px 0' },
};